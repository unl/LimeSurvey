<div id='general'>
    <ul>
        ...
        <?php 
            //echo getEditor("survey-desc", "description", "[" . $clang->gT("Description:", "js") . "]", '', '', '', $action); 
        ?>
        </li>
        ...
        <?php 
            //echo getEditor("survey-welc", "welcome", "[" . $clang->gT("Welcome message:", "js") . "]", '', '', '', $action);
        ?>
        </div>
        </li>
        ...
        <?php 
            //echo getEditor("survey-endtext", "endtext", "[" . $clang->gT("End message:", "js") . "]", '', '', '', $action);
        ?>
        </li>
